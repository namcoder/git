...
function background(){
	$('.bg-slider .item-slider').each(function(){
		var src=$(this).find('.wbbuilder-thumb a img').attr('src');
		$(this).css('background-image','url("'+src+'")');
	});	
}
function animated(){
	$('.wbbuilder-slider .owl-item').each(function(){
...
function slick_animated(){
	$('.wbbuilder-slider .item-slider').each(function(){
...
function background_image(){
	if($('.wbbuilder-background').length>0){
		$('.wbbuilder-background').each(function(){
