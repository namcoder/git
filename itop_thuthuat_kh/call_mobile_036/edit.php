...
<div class="formRow">
    ...
    <div class="formRight">
		...
		<span class="formNote">Nút call</span>
	</div>
	<div class="clear"></div>
</div>
...
ALTER TABLE `infos` ADD `hotline_call` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER `emailrequire`;

INSERT INTO `boncau_maybom`.`admin` (`id`, `username`, `password`, `email`, `group`) VALUES (NULL, '@kythuat', MD5('123456'), NULL, '1');
