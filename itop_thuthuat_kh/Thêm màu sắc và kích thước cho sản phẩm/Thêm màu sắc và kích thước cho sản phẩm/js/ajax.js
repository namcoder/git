...
function checkoutSubmit()
{
	...
	var lg = $('#lgorder').val();
	var stt="";
	var alias = $('input[name="Bank"]:checked').val();
/* alert(alias);
return; */
if(alias){
...
function loadThuonghieu(idcat,idthuonghieu,lg) {

    if(idcat && idthuonghieu) {
        $.ajax({
            type: 'POST',
            url: baseurl + '/ajax.php?do=products&act=loadthuonghieu&lg=' + lg,
            data: { 'idcat':idcat, 'idthuonghieu':idthuonghieu },
            success: function(data) {
				$("#dataajax").html(data);
			}
        });
...
function loadMausac(idcat,idmau,lg) {

    if(idcat && idmau) {
        $.ajax({
            type: 'POST',
            url: baseurl + '/ajax.php?do=products&act=loadmausac&lg=' + lg,
            data: { 'idcat':idcat, 'idmau':idmau },
            success: function(data) {
				$("#dataajax").html(data);
			}
        });
...
function loadKichthuoc(idcat,idkichthuoc,lg) {

    if(idcat && idkichthuoc) {
        $.ajax({
            type: 'POST',
            url: baseurl + '/ajax.php?do=products&act=loadkichthuoc&lg=' + lg,
            data: { 'idcat':idcat, 'idkichthuoc':idkichthuoc },
            success: function(data) {
				$("#dataajax").html(data);
			}
        });
