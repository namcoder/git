...
function Detail()
{
	...
	$sql = "select o.* ,p.name_vn, p.price, p.price_sale, p.saleoff, p.img, p.code, od.namemausac, od.namekichthuoc, od.od_pro_quantity, od.od_size, od.od_price from orders o, order_detail od, products p where o.odr_id=od.od_odr_id and od.od_pro_id=p.id and o.odr_id=".$id;
	$stips = $db->getAll($sql);
}
...
function ViewComplete()
{
	...
	$id = $_POST['id'];
	$arr['ghichu']= isset($_POST["ghichu"])?$_POST["ghichu"]:'';
