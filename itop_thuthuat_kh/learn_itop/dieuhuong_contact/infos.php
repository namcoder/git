...
function Editsm()
{
	...
	$arr['send_email_success_vn'] = SafeFormValue('send_email_success_vn');
	$arr['send_email_success_en'] = SafeFormValue('send_email_success_en');
	$arr['send_email_unsuccess_vn'] = SafeFormValue('send_email_unsuccess_vn');
	$arr['send_email_unsuccess_en'] = SafeFormValue('send_email_unsuccess_en');
	...
	$arr['profileface'] = isset($_POST['profileface'])?$_POST['profileface']:'';
	$arr['twitter'] = isset($_POST['twitter'])?$_POST['twitter']:'';
	...
	$arr['google_analytics'] = str_replace("'", '"', $ga);//strip_tags(str_replace("'", '"', $ga));
	$zopim = isset($_POST["zopim"])?$_POST["zopim"]:'';
	$arr['zopim'] = str_replace("'", '"', $zopim);//strip_tags(str_replace("'", '"', $zopim));
	$arr['webmaster']= isset($_POST["webmaster"])?$_POST["webmaster"]:'';
	...
	$arr['post_footer_vn']= isset($_POST["post_footer_vn"])?$_POST["post_footer_vn"]:'';
	$arr['post_footer_en']= isset($_POST["post_footer_en"])?$_POST["post_footer_en"]:'';
	$arr['pro_footer_vn']= isset($_POST["pro_footer_vn"])?$_POST["pro_footer_vn"]:'';
	$arr['pro_footer_en']= isset($_POST["pro_footer_en"])?$_POST["pro_footer_en"]:'';
	$arr['intro_vn']= isset($_POST["intro_vn"])?$_POST["intro_vn"]:'';



	
	$zopim_sale = isset($_POST["zopim_sale"])?$_POST["zopim_sale"]:'';
	$arr['zopim_sale'] = str_replace("'", '"', $zopim_sale);
	// bao tri
