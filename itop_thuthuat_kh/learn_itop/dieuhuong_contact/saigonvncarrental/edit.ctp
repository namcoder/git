...
<form name="supplier" id="validate" class="form" action="admin.php?do=infos&act=editsm" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
                ...
                <span class="formNote">Host của tài khoản mail phía trên. Nếu là webmail thì host dạng <strong>mail.(tên miền).(phần mở rộng) ví dụ: mail.imgroup.vn</strong>. Nếu là gmail thì host là <strong>smtp.gmail.com</strong></span>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
                ...
                <div class="clear"></div>
                <span class="formNote">Hình logo website (ảnh PNG, GIF, JPEG, JPG). Kích thước chuẩn: 960x120 (px)</span>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
	...
	<div class="widget">
        ...
        <div class="formRow">
			<label>Banner bên trái:</label>
			<div class="formRight"><?php echo $CKEditor->editor("banner_left", $info['banner_left']);?></div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			<label>Banner bên phải:</label>
			<div class="formRight"><?php echo $CKEditor->editor("banner_right", $info['banner_right']);?></div>
			<div class="clear"></div>
		</div>
        <div class="formRow">
        ...
        <div class="formRow">
          ...
          <div class="formRight">
            ...
            <div style="float:left;">
                <?php /*?><input type="checkbox" name="showoptin" id="showoptin" value="1" <?=($info['showoptin']==1)?'checked="checked"':''?>/>
                ...
                <label for="showcart">Hiện giỏ hàng</label><?php */?>
                <input type="checkbox" name="hide_right_sidebar" id="hide_right_sidebar" value="1" <?=($info['hide_right_sidebar']==1)?'checked="checked"':''?>/>
